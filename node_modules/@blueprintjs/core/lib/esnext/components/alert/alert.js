...
export class Alert extends AbstractPureComponent {
    ...
    render() {
        ...
        return (React.createElement(Dialog, { ...overlayProps, className: classNames(Classes.ALERT, className), canEscapeKeyClose: canEscapeKeyCancel, canOutsideClickClose: canOutsideClickCancel, onClose: this.handleCancel, portalContainer: this.props.portalContainer },
