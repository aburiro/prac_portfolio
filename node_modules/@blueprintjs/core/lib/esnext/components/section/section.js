...
export const Section = React.forwardRef((props, ref) => {
    const { children, className, collapseProps, collapsible, compact, elevation, icon, rightElement, subtitle, title, ...htmlProps } = props;
    ...
    return (React.createElement(Card, { className: classNames(className, Classes.SECTION, {
        ...
        }), elevation: elevation, ref: ref, ...htmlProps },
        title && (React.createElement("div", { role: collapsible ? "button" : undefined, "aria-pressed": collapsible ? isCollapsed : undefined, className: classNames(Classes.SECTION_HEADER, {
