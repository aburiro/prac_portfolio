...
export var Section = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(Card, __assign({ className: classNames(className, Classes.SECTION, (_a = {},
        ...
        title && (React.createElement("div", { role: collapsible ? "button" : undefined, "aria-pressed": collapsible ? isCollapsed : undefined, className: classNames(Classes.SECTION_HEADER, (_b = {},
            ...
            isHeaderLeftContainerVisible && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: Classes.SECTION_HEADER_LEFT },
                    ...
                    React.createElement("div", null,
                        React.createElement(H6, { className: Classes.SECTION_HEADER_TITLE }, title),
