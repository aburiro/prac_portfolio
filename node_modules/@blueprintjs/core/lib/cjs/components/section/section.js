...
exports.Section = React.forwardRef(function (props, ref) {
    ...
    var _d = React.useState(!((_c = collapseProps === null || collapseProps === void 0 ? void 0 : collapseProps.defaultIsOpen) !== null && _c !== void 0 ? _c : true)), isCollapsedUncontrolled = _d[0], setIsCollapsed = _d[1];
    ...
    return (React.createElement(card_1.Card, tslib_1.__assign({ className: (0, classnames_1.default)(className, common_1.Classes.SECTION, (_a = {},
            ...
            _a)), elevation: elevation, ref: ref }, htmlProps),
        title && (React.createElement("div", { role: collapsible ? "button" : undefined, "aria-pressed": collapsible ? isCollapsed : undefined, className: (0, classnames_1.default)(common_1.Classes.SECTION_HEADER, (_b = {},
                _b[common_1.Classes.INTERACTIVE] = collapsible,
                _b)), onClick: collapsible != null ? toggleIsCollapsed : undefined },
            isHeaderLeftContainerVisible && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: common_1.Classes.SECTION_HEADER_LEFT },
                    ...
                    React.createElement("div", null,
                        React.createElement(html_1.H6, { className: common_1.Classes.SECTION_HEADER_TITLE }, title),
