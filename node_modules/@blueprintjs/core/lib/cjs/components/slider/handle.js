...
var Handle = /** @class */ (function (_super) {
    ...
    function Handle() {
        ...
        _this.getStyleProperties = function () {
            ...
            var offsetCalc = "calc(".concat((0, sliderUtils_1.formatPercentage)(offsetRatio), " - ").concat(handleMidpoint, "px)");
    ...
    Handle.displayName = "".concat(props_1.DISPLAYNAME_PREFIX, ".SliderHandle");
    return Handle;
